                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="logo_sticky" class="@error('logo_sticky') text-danger @enderror">Logo Sticky</label>
                                    <div class="uniform-uploader">
                                        <input id="logo_sticky" name="logo_sticky" value="{{ old('logo_sticky') }}" type="file" class="form-control form-input-styled @error('logo_sticky') is-invalid @enderror" data-fouc="">
                                    </div>
                                    @if(isset($site->logo_sticky))
                                        <div class="image-output">
                                            <a target="_blank" href="{{ $site->logo_sticky->file_url }}">
                                                <img src="{{ $site->logo_sticky->file_url }}">
                                            </a>
                                        </div>
                                    @endif
                                    @error('logo_sticky')
