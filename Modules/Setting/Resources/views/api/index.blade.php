                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <h5 class="font-weight-bold">Strava API credentials</h5>
                                        <hr>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="strava_client_id" class="@error('strava_client_id') text-danger @enderror">Stripe Secret</label>
                                            <input id="strava_client_id" name="strava_client_id" value="{{ old('strava_client_id') ?: $api->strava_client_id }}" type="text" class="form-control @error('strava_client_id') is-invalid @enderror" placeholder="Enter client id" autofocus>
                                            @error('strava_client_id')
                                            <span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong></span>
                                            @enderror
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="strava_client_secret" class="@error('strava_client_secret') text-danger @enderror">Client Secret</label>
                                            <input id="strava_client_secret" name="strava_client_secret" value="{{ old('strava_client_secret') ?: $api->strava_client_secret }}" type="text" class="form-control @error('strava_client_secret') is-invalid @enderror" placeholder="Enter client secret" autofocus>
                                            @error('strava_client_secret')
                                            <span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong></span>
                                            @enderror
                                        </div>
                                    </div>
