        ...
        <div class="page-header-content header-elements-md-inline">
            <div class="page-title d-flex">
                <h4>
                    ...
                    <span class="font-weight-semibold">Cases</span> - Update
                </h4>
            </div>
        </div>
            ...
            <div class="col-md-12">
                ...
                <div class="card">
                    <div class="card-header header-elements-inline">
                        <h5 class="card-title">Update Cases</h5>
                    ...
                    {!! Form::open(['url' => route('backend.cms.cases.update', [$cases->id]), 'method' => 'put', 'files' => true]) !!}
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="title" class="@error('title') text-danger @enderror">Title</label>
                                    <input id="title" name="title" value="{{ old('title') ?? $cases->title }}"
                                ...
                                <div class="form-group">
                                    ...
                                    <select id="area_id" name="area_id" type="text" class="form-control form-control-select2 @error('area_id') is-invalid @enderror" autofocus>
                                        ...
                                        @foreach($countries as $country)
                                            <option value="{{ $country->id }}" {{ $cases->area_id == $country->id ? 'selected' : '' }}>{{ $country->country_name }}</option>
                                        @endforeach
                                    </select>
                                    @error('area_id')
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input id="affected_people" name="affected_people" value="{{ old('affected_people') ?? $cases->affected_people }}"
                                           type="number" min="1" class="form-control @error('affected_people') is-invalid @enderror"
                                           placeholder="Enter affected people" autofocus>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input id="needed_money" name="needed_money" value="{{ old('needed_money') ?? $cases->needed_money }}"
                                           type="number" min="0" step="any" class="form-control @error('needed_money') is-invalid @enderror"
                                           placeholder="Enter needed money" autofocus>
                                    @error('needed_money')
                                    <span class="invalid-feedback"
                                          role="alert"><strong>{{ $message }}</strong></span>
                                    @enderror
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea id="description" name="description" class="form-control ck-text-editor @error('description') is-invalid @enderror" rows="3"
                                              placeholder="Enter description">{{ old('description') ?? $cases->description }}</textarea>
                                    @error('description')
                                    <span class="invalid-feedback"
                                          role="alert"><strong>{{ $message }}</strong></span>
                                    @enderror
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    @if(isset($cases->image))
                                        <div class="image-output">
                                            <a target="_blank" href="{{ $cases->image->file_url }}">
                                                <img src="{{ $cases->image->file_url }}">
                                            </a>
                                        </div>
                                    @endif
                                    @error('image')
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="attachment" class="@error('attachment') text-danger @enderror">Cases Attachment</label>
                                    <div class="uniform-uploader">
                                    ...
                                    @if(isset($cases->attachment))
                                        <div class="image-output">
                                            Attachment: <span class="text-success d-block">{{ $cases->image->file_name }}</span>
                                            <a target="_blank" href="{{ $cases->image->file_url }}">
                                                Download Attachment
                                            </a>
                                        </div>
