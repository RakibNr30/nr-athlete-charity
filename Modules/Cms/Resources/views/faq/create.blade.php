@extends('admin.layouts.master', ['active' => [2, 5, 0]])
        ...
        <div class="page-header-content header-elements-md-inline">
            <div class="page-title d-flex">
                <h4>
                    ...
                    <span class="font-weight-semibold">Faq</span> - Create
                </h4>
            </div>
        </div>
            ...
            <div class="col-md-12">
                ...
                <div class="card">
                    <div class="card-header header-elements-inline">
                        <h5 class="card-name">Create Faq</h5>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea id="answer" name="answer" class="form-control ck-text-editor @error('answer') is-invalid @enderror" rows="3" placeholder="Enter answer">{{ old('answer') }}</textarea>
                                    @error('answer')
                                    <span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong></span>
                                    @enderror
                                </div>
