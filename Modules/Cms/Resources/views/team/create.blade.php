        ...
        <div class="page-header-content header-elements-md-inline">
            <div class="page-title d-flex">
                <h4>
                    ...
                    <span class="font-weight-semibold">Team Member</span> - Add
                </h4>
            </div>
        </div>
        <div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
            <div class="d-flex">
                <div class="breadcrumb">
                    ...
                    <span class="breadcrumb-item active">Member Add</span>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="col-md-12">
                ...
                <div class="card">
                    <div class="card-header header-elements-inline">
                        <h5 class="card-name">Add Team Member</h5>
                    ...
                    {!! Form::open(['url' => route('backend.cms.team.store'), 'method' => 'team', 'files' => true]) !!}
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-12">
