        ...
        <div class="page-header-content header-elements-md-inline">
            <div class="page-title d-flex">
                <h4>
                    ...
                    <span class="font-weight-semibold">Rice Price</span>
                </h4>
            </div>
        </div>
        <div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
            <div class="d-flex">
                <div class="breadcrumb">
                    ...
                    <span class="breadcrumb-item active">Rice Price</span>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="col-lg-12">
                ...
                <div class="card">
                    <div class="card-header header-elements-inline">
                        <h5 class="card-title">Global Rice Price List</h5>
                        <div class="header-elements">
                            <div class="list-icons">
                                <a href="{{ route('backend.cms.rice.create') }}" class="btn btn-info text-white">Add New Price</a>
                            </div>
                        </div>
                    </div>
