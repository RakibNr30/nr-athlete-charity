@extends('front.layouts.master', ['active' => [8, 1]])
                        ...
                        <div class="page-title-wrapper text-center pt-60">
                            <div class="page-title-box">
                                ...
                                <ul class="breadcrumb-list">
                                    ...
                                    <li><a class="active">{{ __('front/profile/index.donation_history') }}</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="standard-right-area">
                            <div class="widget mb-30 wow fadeInUp2  animated" data-wow-delay=".1s" style="visibility: visible; animation-delay: 0.1s; animation-name: fadeInUp2;">
                                <ul class="widget-cat">
                                    ...
                                    <li class="active"><a href="{{ route('front.profile-donation-history.index') }}">{{ __('front/profile/index.donation_history') }}</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-9 col-lg-9 col-md-12">
                        <div class="blogs-details-left-area mb-50">
                            <div class="comment-form">
                                <h3 class="cases-title mb-30">{{ __('front/profile/index.donation_history') }}</h3>
                                <div class="row">
                                    <div class="col-xl-12">
                                        <table class="table">
                                            <thead>
